...
describe('MappingResolver', () => {
  describe('computeSlot', () => {
    it('should compute correct storage slot for single mapping', () => {
      ...
      const expected = keccak256(solidityPacked(['bytes32', 'bytes32'], [key, slot]));
    ...
    it('should be deterministic', () => {
      ...
      const result1 = keccak256(solidityPacked(['bytes32', 'bytes32'], [key, slot]));
      const result2 = keccak256(solidityPacked(['bytes32', 'bytes32'], [key, slot]));
    ...
    it('should produce different slots for different keys', () => {
      ...
      const result1 = keccak256(solidityPacked(['bytes32', 'bytes32'], [key1, slot]));
      const result2 = keccak256(solidityPacked(['bytes32', 'bytes32'], [key2, slot]));
  ...
  describe('computeNestedSlot', () => {
    it('should compute correct nested mapping slot', () => {
      ...
      const innerSlot = keccak256(solidityPacked(['bytes32', 'bytes32'], [key1, slot]));
      const outerSlot = keccak256(solidityPacked(['bytes32', 'bytes32'], [key2, innerSlot]));
    ...
    it('should be order-dependent', () => {
      ...
      const innerSlot2 = keccak256(solidityPacked(['bytes32', 'bytes32'], [key2, slot]));
      const outerSlot2 = keccak256(solidityPacked(['bytes32', 'bytes32'], [key1, innerSlot2]));
  ...
  describe('computeAddrSlot', () => {
    it('should compute correct slot for address key', () => {
      ...
      const result = keccak256(solidityPacked(['bytes32', 'bytes32'], [key, slot]));
